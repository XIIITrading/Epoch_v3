...
CREATE INDEX IF NOT EXISTS idx_j_ramp_up_trade ON j_m1_ramp_up_indicator (trade_id);
CREATE INDEX IF NOT EXISTS idx_j_ramp_up_ticker_date ON j_m1_ramp_up_indicator (ticker, bar_date);
