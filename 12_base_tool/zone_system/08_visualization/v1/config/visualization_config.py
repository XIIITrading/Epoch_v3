...
# Number of M15 bars to display
DEFAULT_BAR_COUNT = 120  # ~30 hours of M15 data (covers multiple sessions)
...
VP_BASE_COLOR = '#5c6bc0'  # Base color for volume bars
VP_HVN_COLOR = '#ffeb3b'   # Highlight color for top 10 HVN zones
