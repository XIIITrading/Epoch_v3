...
Entry Indicators - CLI Runner
XIII Trading LLC
================================================================================

Command-line interface for running the Entry Indicators population.
...
def run_schema():
    """Execute the schema SQL to create the entry_indicators table."""
    import psycopg2

    schema_file = SCHEMA_DIR / "entry_indicators.sql"
    ...
    print("=" * 60)
    print("Entry Indicators - Schema Creation")
    print("=" * 60)
...
def run_population(args):
    """Run the entry indicators population."""
    print()
    print("=" * 60)
    print("EPOCH TRADING SYSTEM")
    print("Entry Indicators Calculator v1.0.0")
    print("=" * 60)
    print()
    ...
    populator = EntryIndicatorsPopulator(verbose=args.verbose)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Calculate Entry Indicators for trades',
...
Output:
  Results are written to the entry_indicators table in Supabase.
  Each trade gets one row with indicator snapshots at entry time.
        """
    )
    ...
    parser.add_argument(
        '--schema',
        action='store_true',
        help='Run schema creation only (create entry_indicators table)'
    )
