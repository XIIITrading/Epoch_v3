...
M1 Indicator Bars - Market Structure Detection
XIII Trading LLC
================================================================================
...
Adapted from m5_indicator_bars/structure.py with M1 support.
...
if __name__ == "__main__":
    print("M1 Indicator Bars - Structure Detection")
    print("=" * 60)
    ...
    print("  result = analyzer.get_structure('SPY', 'M1', date(2025, 12, 30), time(12, 0))")
