...
def build_compact_prompt(
    ...
    candle_range, vol_delta, vol_roc, sma_config, h1_structure = _calculate_5bar_averages(bars_data)
...
def _calculate_5bar_averages(bars_data: List[Dict]) -> tuple:
    ...
    return avg_candle_range, avg_vol_delta, avg_vol_roc, sma_config, h1_structure
