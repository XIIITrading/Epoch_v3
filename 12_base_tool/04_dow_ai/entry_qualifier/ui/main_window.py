...
class MainWindow(QMainWindow):
    ...
    Displays up to 6 ticker panels with rolling indicator data.
    ...
    def _setup_ui(self):
        ...
        self.setWindowTitle("EPOCH ENTRY QUALIFIER v1.0")
        ...
        # Scrollable area for ticker panels
        ...
        # Reduce spacing before DOW AI section
        ...
        # DOW AI Terminal Panel (no extra spacing)
    ...
    def _create_header(self) -> QHBoxLayout:
        ...
        # Title
        title = QLabel("EPOCH ENTRY QUALIFIER v1.0")
    ...
    def _create_status_bar(self) -> QFrame:
        ...
        # Ticker count
        self.ticker_count_label = QLabel("Tickers: 0/6")
    ...
    def _reorder_panels(self):
        ...
        # Reorder in layout
        for i, panel in enumerate(active_panels + empty_panels):
    ...
    @pyqtSlot(str, str)
    def _on_ai_query(self, ticker: str, direction: str):
        """
        Handle AI query request from control panel.
        ...
        # Start new AI query
        self._ai_worker = AIQueryWorker(ticker, direction, bars, self)
