...
DATA SOURCES:
    --source excel    : Load zones from Excel Analysis worksheet (default)
    --source supabase : Load zones from Supabase setups table (requires date)
...
def main():
    ...
    parser.add_argument('--source', choices=['excel', 'supabase'], default='excel',
                        help='Data source for zones (default: excel)')
    ...
    if excel_writer:
        ...
        print("Note: To export results to Supabase, use the database_export module.")
