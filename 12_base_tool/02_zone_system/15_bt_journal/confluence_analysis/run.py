...
def run(
    ...
    if verbose and standalone:
        ...
        print("Confluence Analysis - Direction-Relative Factor Alignment")
        print("=" * 60)
        print()
    ...
    if verbose:
        if result.factor_alignments:
            ...
            for fa in result.factor_alignments[:5]:  # Top 5
                print(f"    {fa.factor_name:15} {fa.alignment_edge * 100:+.1f}% edge "
                      f"(aligned {fa.aligned_win_rate * 100:.0f}% vs misaligned {fa.misaligned_win_rate * 100:.0f}%)")
            print()
    ...
    if standalone:
        ...
        if excel_exporter:
            ...
            if verbose:
                print("  Added Excel worksheet: Confluence")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Epoch Confluence Analysis - Direction-Relative Factor Alignment",
