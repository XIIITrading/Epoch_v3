...
M5 Indicator Bars - Configuration
XIII Trading LLC
================================================================================

Self-contained configuration for the M5 Indicator Bars calculation module.
Stores direction-agnostic M5 bars with full indicators for all ticker+dates.
...
TARGET_TABLE = "m5_indicator_bars"
