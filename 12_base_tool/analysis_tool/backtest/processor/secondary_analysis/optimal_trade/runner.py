...
Usage:
    ...
    python runner.py --limit 5 --dry-run # Test with 5 trades, no write
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Optimal Trade Calculator (Points-Based) v2.0.0',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
    python runner.py                      Full calculation run
    python runner.py --limit 10           Process only 10 trades
    ...
    print("Points-Based Calculation (v2.0.0)")
    print("=" * 70)
    print()
