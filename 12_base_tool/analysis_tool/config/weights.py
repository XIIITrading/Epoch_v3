...
# =============================================================================
# ZONE WEIGHTS (Technical level confluence weights)
# =============================================================================
ZONE_WEIGHTS = {
    # Monthly Levels
...
# =============================================================================
# L1-L5 RANKING THRESHOLDS (Fixed score thresholds)
# =============================================================================
...
def get_rank_from_score(score: float) -> str:
    """
    Determine L-rank from confluence score.

    Args:
        score: Total confluence score

    Returns:
        Rank string ('L1' through 'L5')
    """
    if score >= RANKING_SCORE_THRESHOLDS['L5']:
        return 'L5'
    elif score >= RANKING_SCORE_THRESHOLDS['L4']:
        return 'L4'
    elif score >= RANKING_SCORE_THRESHOLDS['L3']:
        return 'L3'
    elif score >= RANKING_SCORE_THRESHOLDS['L2']:
        return 'L2'
    else:
        return 'L1'


def get_tier_from_rank(rank: str) -> str:
    """
    Get tier from L-rank.

    Args:
        rank: L-rank string ('L1' through 'L5')
...
def get_zone_display_name(zone_key: str) -> str:
    """
    Get human-readable name for a zone key.

    Args:
        zone_key: Internal zone key (e.g., 'm1_01', 'd1_s3')

    Returns:
        Display name (e.g., 'M Open', 'D S3')
    """
    return ZONE_NAME_MAP.get(zone_key, zone_key)
