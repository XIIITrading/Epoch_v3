...
Usage:
    ...
    python -m vwap_simple.vwap_edge --models EPCH01,EPCH03
    python -m vwap_simple.vwap_edge --direction LONG
    python -m vwap_simple.vwap_edge --output results/vwap_2025.md
"""
