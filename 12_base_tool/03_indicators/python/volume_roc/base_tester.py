...
class EdgeTestResult:
    ...
    indicator: str              # e.g., "Volume ROC"
    test_name: str              # e.g., "Vol ROC Level"
...
def fetch_volume_roc_data(
    ...
    """
    Fetch trade data joined with volume ROC from prior M1 bar.
    ...
    Returns DataFrame with columns:
        ...
        vol_roc (from prior M1 bar), is_winner
    """
    query = """
