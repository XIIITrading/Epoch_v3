"""
Base infrastructure for Candle Range indicator edge testing.
...
def fetch_candle_range_data(
    ...
    """
    Fetch trade data joined with OHLC from prior M1 bar for candle range calculation.
    ...
    Returns DataFrame with columns:
        ...
        bar_open, bar_high, bar_low, bar_close (from prior M1 bar), is_winner
    """
    query = """
    ...
    SELECT
        ...
        twpb.entry_time,
        twpb.prior_bar_time,
        -- OHLC from prior M1 bar for candle range calculation
        m1.open as bar_open,
        m1.high as bar_high,
        m1.low as bar_low,
        m1.close as bar_close,
        -- Also include volume indicators for composite analysis
        m1.vol_roc,
        m1.vol_delta,
