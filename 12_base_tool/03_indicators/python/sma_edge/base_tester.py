"""
Base infrastructure for SMA indicator edge testing.
...
def fetch_sma_data(
    ...
    """
    Fetch trade data joined with SMA indicators from prior M1 bar.
    ...
    Returns DataFrame with columns:
        ...
        sma9, sma21, sma_spread, sma_momentum_label (from prior M1 bar), is_winner
    """
    query = """
    ...
    SELECT
        ...
        twpb.entry_time,
        twpb.prior_bar_time,
        -- SMA indicators from prior M1 bar
        m1.sma9,
        m1.sma21,
        m1.sma_spread,
    ...
    WHERE sa.stop_type = %s
      ...
      AND m1.sma9 IS NOT NULL
      AND m1.sma21 IS NOT NULL
    """
