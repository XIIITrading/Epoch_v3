...
M5 Bar Data Fetcher - Polygon API Integration
XIII Trading LLC
================================================================================

Fetches M5 (5-minute) bar data from Polygon API for exit management.
Extended premarket fetch from prior trading day 16:00.
================================================================================
"""
import sys
...
class M5Fetcher:
    ...
    def fetch_bars(self, ticker: str, from_date: str, to_date: str,
                   from_time: str = "00:00", to_time: str = "23:59") -> List[M5Bar]:
    ...
    def fetch_bars_extended(self, ticker: str, trade_date: str,
        ...
        if filtered_bars:
            ...
            print(f"  Fetched {len(filtered_bars)} M5 bars for {ticker} (extended hours)")
