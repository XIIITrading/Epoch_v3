...
# Add local indicators library (self-contained in 03_backtest/processor/indicators)
_INDICATORS_LIB = Path(__file__).parent.parent.parent / "indicators"
sys.path.insert(0, str(_INDICATORS_LIB))
