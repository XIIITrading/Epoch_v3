...
# Default stop type - M5 ATR (1.1x) Close-Based
# Rationale:
# - Canonical stop: trades_m5_r_win uses M5 ATR(14) x 1.1 close-based
# - Best performance: 54.39% win rate, +0.682R expectancy
# - Close-based detection: Avoids wick-based false triggers
# - Aligned with r_win_loss: Same methodology as ATR secondary processor
